class FAQSection {
  ...
  <div class="container" style="max-width: 800px;">
    <div class="text-center mb-4">
      <h2 class="fw-bold">Frequently Asked <span class="main-gradient-text">Questions</span></h2>
    ...
    .map(
      (item, i) => `
        <div class="faq-item mb-2"> <div class="faq-header d-flex justify-content-between align-items-center py-4 cursor-pointer collapsed" 
               data-bs-toggle="collapse" 
               data-bs-target="#faq-${i}">
            <h6 class="fw-600 mb-0">${item.q}</h6>
